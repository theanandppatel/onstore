      ...
      <footer aria-label="Site Footer" className="bg-indigo-100">
        <div className="mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 md:gap-52 sm:grid-cols-2 lg:grid-cols-4 ml-10">
            <div className="text-left">
              ...
              <nav aria-label="Footer About Nav" className="mt-8">
                <ul className="space-y-4 text-sm">
                  <li>
                    <Link href={'/cart'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Contact Us</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>About Us</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Careers</a>
                    </Link>
                  </li>
                </ul>
              </nav>
            ...
            <div className="text-left">
              ...
              <nav aria-label="Footer Category Nav" className="mt-8">
                <ul className="space-y-4 text-sm">
                  <li>
                    <Link href={'/fashion'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Fashion Products</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/homefurnishing'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Home Furnishing</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/electronics'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Electronic Items</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/grocery'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Grocery</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/personalcare'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Beauty & Personal Care</a>
                    </Link>
                  </li>
                </ul>
              </nav>
            ...
            <div className="text-left">
              <p className="text-lg font-medium text-gray-900">Consumer Policy</p>
              <nav aria-label="Footer Services Nav" className="mt-8">
                <ul className="space-y-4 text-sm">
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Return Policy</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Terms of Use</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Privacy</a>
                    </Link>
                  </li>
            ...
            <div className="text-left">
              ...
              <nav aria-label="Footer Helpful Nav" className="mt-8">
                <ul className="space-y-4 text-sm">
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>FAQs</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Terms and Conditions</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Support</a>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/'}>
                      <a className='text-gray-700 transition hover:text-blue-600'>Live Chat</a>
                    </Link>
                  </li>
                </ul>
              </nav>
          ...
          <div className="mt-16">
            <div className='md:flex justify-between'>
              <ul>
                <img className="h-10 items-center" src="../../images/razorpay-payment.png" alt="" />
                ...
                <li>
                  <Link href={'/'} rel="noreferrer" target="_blank">
                    <a className="text-indigo-700 transition hover:text-indigo-700/75">
                      <span className="sr-only" href={'https://facebook.com'}>Facebook</span>
