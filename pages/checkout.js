            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 pt-24 mb-20">
                ...
                <div className="px-4 pt-8">
                                ...
                                <div key={k} className="flex flex-col rounded-lg bg-white sm:flex-row">
                                    ...
                                    <div className="flex w-full flex-col px-5 py-4">
                                        ...
                                        <div className='space-x-7'>
                                            {cart[k].size != "" && <span className="text-gray-400">Size: {cart[k].size}</span>}
                                            {cart[k].variant != "" && <span className="text-gray-400">Color: {capitalizeFirstLetter(cart[k].variant)}</span>}
                                        </div>
                    ...
                    <form className="mt-5 grid gap-6">
                        <div className="relative" onClick={(e) => { setPaymentmethod(true); setOnlineCheck(true); setCodCheck(false) }}>
                            <input onChange={(e) => { }} className="peer hidden" id="radio_1" type="radio" name="radio" checked={onlineCheck} />
                        ...
                        <div className="relative" onClick={(e) => { setPaymentmethod(false); setOnlineCheck(false); setCodCheck(true) }} >
                            <input onChange={(e) => { }} className="peer hidden" id="radio_2" type="radio" name="radio" checked={codCheck} />
                            <span className="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        <label htmlFor="full-name" className="mt-4 mb-2 block text-sm font-medium">Full Name<span className='text-red-600'>*</span></label>
                        <div className="relative">
                            <input onChange={handleChange} value={fullname} type="text" id="full-name" name="full-name" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Your Full Name Here" required />
                        ...
                        <label htmlFor="email" className="mt-4 mb-2 block text-sm font-medium">Email<span className='text-red-600'>*</span></label>
                        <div className="relative">
                        ...
                        <label htmlFor="contact-number" className="mt-4 mb-2 block text-sm font-medium">Contact Number<span className='text-red-600'>*</span></label>
                        <div className="relative">
                            <input onChange={handleChange} value={phone} type="number" id="number" name="contact-number" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="91XXX XXXXX" />
                            <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                <svg style={{ color: "rgb(156, 163, 175)" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone-fill" viewBox="0 0 16 16"> <path fillRule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" fill="#9ca3af"></path> </svg>
                            </div>
                        </div>
                        <label htmlFor="address" className="mt-4 mb-2 block text-sm font-medium">Shipping Address</label>
                        <div className="relative">
                            <textarea onChange={handleChange} value={address} name='address'
                        ...
                        <div className="flex gap-5">
                            <div className="sm:w-1/2">
                                ...
                                <input onChange={handleChange} name='zipcode' value={zipcode} type="number" className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500 w-full" placeholder="Pin Code" />
                            </div>
                            <div className="sm:w-1/2">
                                <label htmlFor="city" className="mt-4 mb-2 block text-sm font-medium">City</label>
                                <input onChange={handleChange} name='city' value={city} type="text" className="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="City" />
                            </div>
                        ...
                        <div className="flex gap-5">
                            <div className="sm:w-1/2">
                                ...
                                <input onChange={handleChange} name='state' value={state} type="text" className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500 w-full" placeholder="State" />
                            </div>
                            <div className="sm:w-1/2">
                                <label htmlFor="country" className="mt-4 mb-2 block text-sm font-medium">Country</label>
                                <input onChange={handleChange} name='country' value={country} type="text" className="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Country" />
                            </div>
                            {/* <input type="text" name="credit-cvc" className="w-1/6 flex-shrink-0 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="CVC" /> */}
                        </div>
                        ...
                        <div className="mt-6 border-t border-b py-2">
                            <div className="flex items-center justify-between">
                                ...
                                <p className="font-semibold text-gray-900">₹{subTotal.toLocaleString('en-IN')}</p>
                            </div>
                            <div className="flex items-center justify-between">
                                <p className="text-sm font-medium text-gray-900">Shipping</p>
                                <p className="font-semibold text-gray-900">{subTotal == 0 ? "-" : (subTotal < 1000 && subTotal != 0 ? "₹40" : "FREE").toLocaleString('en-IN')}</p>
                            </div>
                        </div>
                        <div className="mt-6 flex items-center justify-between">
                            <p className="text-sm font-medium text-gray-900">Total</p>
                            <p className="text-2xl font-semibold text-gray-900">₹{(subTotal + (subTotal < 1000 && subTotal != 0 ? 40 : 0)).toLocaleString('en-IN')}</p>
                        </div>
                    </div>
                    <button disabled={disabled} className="disabled:bg-gray-400 hover:bg-gray-800 mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white" onClick={handleProceedPay}>Place Order</button>
                </div>
            </div>
        </div>
    )
