                      ...
                      <div className="lg:flex py-1 md:py-4  text-sm text-gray-600">
                        ...
                        {/* <div className="flex-1 inline-flex items-center mb-0 md:mb-3">
                          ...
                          <div className="cursor-pointer text-gray-400 ">
                            {electronicproducts[item].size.includes('S') && <span className="hover:text-purple-900 p-1 py-0">S</span>}
                            {electronicproducts[item].size.includes('M') && <span className="hover:text-purple-900 p-1 py-0">M</span>}
                            {electronicproducts[item].size.includes('L') && <span className="hover:text-purple-900 p-1 py-0">L</span>}{electronicproducts[item].size.includes('XL') && <span className="hover:text-purple-900 p-1 py-0">XL</span>}
                            {electronicproducts[item].size.includes('XXL') && <span className="hover:text-purple-900 p-1 py-0">XXL</span>}
                          </div>
                        </div> */}
                      </div>
