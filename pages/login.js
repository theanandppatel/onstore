...
const Login = () => {
      ...
      const handleCallbackRespnse = async (res) => {
        if (res) {
          ...
          let result = await fetch(
            `${process.env.NEXT_PUBLIC_HOST}/api/googlesignin`,
            {
              method: "POST",
              headers: {
  ...
  return (
    ...
    <div className="pt-14 lg:pt-3">
      <Head>
        <title>Login Page - Onstore</title>
        <meta
          name="description"
      ...
      <Script
        ...
        rel="stylesheet"
      />
      <Script href="https://accounts.google.com/gsi/client" />
      <meta
        name="viewport"
              ...
              <div className="mx-auto max-w-xs">
                ...
                {passwordicon ? (
                  <AiFillEye
                    ...
                    className="absolute -mt-9 ml-72 cursor-pointer text-xl"
                  />
                ) : (
                  <AiFillEyeInvisible
                    onClick={handlePassShow}
                    className="cursor-pointer text-xl absolute -mt-9 ml-72"
                  />
                )}
