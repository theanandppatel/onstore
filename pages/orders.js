...
const Orders = ({ logout, token }) => {
  ...
  const dateFormat = (d) => {
    var t = new Date(d);
    return (
      (t.getDate() < 10 ? date[t.getDate()] : t.getDate()) +
      " " +
  ...
  return (
    <div>
      <Head>
        <title>Orders Page - Onstore</title>
        <meta
          name="description"
      ...
      <div className="mb-5">
        <h1 className="text-4xl font-bold lg:ml-24 pt-32 ml-5">
          Order history
        </h1>
        <p className="lg:ml-24 mt-3 text-gray-500 ml-5">
        ...
        <div className="lg:flex lg:flex-row">
          ...
          <div className="bg-white sm:rounded-lg w-full lg:w-4/5 mt-10 lg:mt-24 mb-32 lg:mx-0 px-5">
            {orders.length == 0 ? (
              <div className="text-gray-500 text-lg text-center pb-44 pt-8">
                    ...
                    <div key={item._id} className="mb-32">
                      <div className="flex justify-between">
                        <div className="grid grid-cols-2 lg:space-x-6 space-x-1">
                          <div className="lg:flex ">
                            <h2 className="mt-4 mb-2 block text-sm font-medium text-gray-500 lg:ml-24">
                              Order ID: <br></br>
                              <span className="text-black font-semibold">
                                {item.orderId}
                              </span>
                            </h2>
                            <h2 className="mt-4 mb-2 block text-sm font-medium text-gray-500 lg:ml-12">
                              Date: <br></br>
                              <span className="text-black font-semibold">
                        ...
                        <button
                          onClick={() =>
                            router.push("/order?id=" + item.orderId)
                          }
                          type="button"
                          className="xs:h-12 py-2.5 px-5 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 justify-end self-center align-middle lg:mr-24 mt-3"
                        >
                          View Details
                        </button>
                      </div>
                      ...
                      {Object.keys(item.products).map((k) => {
                        return (
                          <div
                            key={k}
                            className="flex  rounded-lg bg-white lg:ml-24 mb-5"
                          >
                            <img
                              className="m-2 h-24 w-28 object-contain"
                              src={item.products[k].image}
                              alt=""
                            />
