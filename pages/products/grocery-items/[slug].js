...
const Groceryitems = ({ error, open, setOpen, cart, clearCart, addToCart, products, buyNow, productImgArr, prodHighlights, prodDetails }) => {
            ...
            <div className="bg-white">
                ...
                <div className="pt-6">
                    ...
                    <div className="mx-auto max-w-2xl px-4 pt-3  sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0 px-5 h-full flex flex-col">
...
export async function getServerSideProps(context) {
    ...
    if (products == null || products.category != 'grocery-items') {
        return {
