...
export async function getServerSideProps(context) {
    ...
    let products = await FeaturedProduct.findOne({ slug: context.query.slug })
    ...
    let variants = await FeaturedProduct.find({ title: products.title })
    let imgVariants = await FeaturedProduct.find({ color: products.color, title: products.title })
